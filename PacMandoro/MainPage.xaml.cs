...
namespace PacMandoro
{
    ...
    {
        private const string StartNowAnnounceSoundFile = "ms-appx:///Assets/Pac-Man_Eat_Fruit.wav";
        private const string AddDeleteTasksSoundFile = "ms-appx:///Assets/Insert_Coin.wav";
        private const string TaskBeginningSoundFile = "ms-appx:///Assets/Pac-Man_Beginning.wav";
        private const string TaskEndSoundFile = "ms-appx:///Assets/Pac-Man_Death.wav";
        private const string BreakBeginningSoundFile = "ms-appx:///Assets/Pac-Man_Intermission.wav";
